...
<div className="navbar max-w-screen-2xl mx-auto">
  ...
  {
      loading ? '':  (
        user && user.email ? <NavLink to={isAdmin ? '/dashboard/announcement':'/dashboard/addPost'}><button className='btn btn-success text-white text-base font-bold'><span className='text-base'><FiPlus /></span>Post</button></NavLink> : ''
     ) }
  <button className="btn btn-ghost btn-circle">
      <div className="indicator">
        ...
        <span className="badge indicator-item text-base">{announcements.length}</span>
      </div>
    </button>
    {
      loading ? '':  (
